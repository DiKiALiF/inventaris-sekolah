                ...
                <div class="card-body">
                   <form action="{{route('barang_keluar.update',$barang_keluar->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_barang" class="form-control @error('id_barang') is-invalid @enderror" >
                                @foreach($barang as $data)
                                    <option value="{{$data->id}}" {{$data->id == $barang_keluar->id_barang ? 'selected="selected"' : '' }}>{{$data->nama_barang}}</option>
                                @endforeach
                            </select>
                            @error('id_barang')
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="jumlah" value="{{$barang_keluar->jumlah}}"
